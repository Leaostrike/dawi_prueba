...
public class FrmManteProd_table2 extends JFrame implements ActionListener, MouseListener, KeyListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmManteProd_table2 frame = new FrmManteProd_table2();
